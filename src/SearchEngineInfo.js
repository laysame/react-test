      ...
      <Row>
        <Col className="SearchEngine Header col-6 pe-0 ms-5 mt-5">
          <div>
            ...
            <span className="SearchEngine Temperature">
              {props.data.temperature}°
            </span>
            <ButtonGroup size="mb-2">
              <Button className="btn" onClick={() => onUnitChange('metric')}>
                °C
              </Button>
              <Button className="btn" onClick={() => onUnitChange('imperial')}>
                °F
              </Button>
            </ButtonGroup>
          </div>
        ...
        <Col className="SearchEngine col mt-5 p-0">
          <nav className="SearchEngine ms-3">
            <ul className="SearchEngine Description">
              <li>
                <FontAwesomeIcon icon="temperature-high" /> Feels Like:{' '}
                {props.data.feelsLike}°
              </li>
              <li>
                <FontAwesomeIcon icon="arrow-circle-up" /> {props.data.tempMax}°
                <FontAwesomeIcon icon="arrow-circle-down" />{' '}
                {props.data.tempMin}°
              </li>
              <li>
                <FontAwesomeIcon icon="water" /> Humidity: {props.data.humidity}
                %
              </li>
              <li>
                <FontAwesomeIcon icon="wind" /> Wind: {props.data.wind}km/H
              </li>
            </ul>
          </nav>
        </Col>
